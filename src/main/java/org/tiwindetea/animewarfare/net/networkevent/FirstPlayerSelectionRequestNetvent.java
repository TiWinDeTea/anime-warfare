...
public class FirstPlayerSelectionRequestNetvent implements Event<FirstPlayerSelectionRequestNetventListener> {
    ...
    public GameClientInfo getPlayerThatSelects() {
        return this.playerThatSelects;
    }

    /**
     * @return An unmodifiable list of selectable players, as specified in {@link Collections#unmodifiableList(List)}
     */
    public List<GameClientInfo> getSelectablePlayers() {
