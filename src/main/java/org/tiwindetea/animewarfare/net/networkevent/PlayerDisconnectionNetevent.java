 ...
 * @since 0.1.0
 */
public class PlayerDisconnectionNetevent implements Event<PlayerDisconnectionNeteventListener> {
    ...
    @Override
    public void notify(PlayerDisconnectionNeteventListener listener) {
        listener.handlePlayerDisconnection(this);
    }
