...
public class NextPlayerNetevent implements Event<NextPlayerNeteventListener> {
	private final GameClientInfo gameClientInfo;

	public NextPlayerNetevent(NetNextPlayer netNextPlayer) {
		this.gameClientInfo = netNextPlayer.getNextPlayer();
	}

	@Override
	public void notify(NextPlayerNeteventListener listener) {
