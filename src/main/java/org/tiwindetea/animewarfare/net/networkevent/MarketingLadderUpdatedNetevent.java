 ...
 * @since 0.1.0
 */
public class MarketingLadderUpdatedNetevent implements Event<MarketingLadderUpdatedNeteventListener> {
    ...
    @Override
    public void notify(MarketingLadderUpdatedNeteventListener listener) {
        listener.handleMarketingLadderUpdate(this);
    }
