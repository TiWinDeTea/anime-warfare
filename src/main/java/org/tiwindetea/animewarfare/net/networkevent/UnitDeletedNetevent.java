 ...
 * @since 0.1.0
 */
public class UnitDeletedNetevent implements Event<UnitDeletedNeteventListener> {

    private final int unitId;
    private final FactionType factionType;
    private final UnitType unitType;

    public UnitDeletedNetevent(NetUnitCountChange unitCountChange) {
    ...
    @Override
    public void notify(UnitDeletedNeteventListener listener) {
        listener.handleUnitDeletion(this);
    }
