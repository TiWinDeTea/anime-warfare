 ...
 * @since 0.1.0
 */
public class NetFactionSelected implements NetReceivable {
     ...
     */
    public NetFactionSelected() {
        this.gameClientInfo = null;
        this.faction = null;
    }

    public NetFactionSelected(FactionType factionType, GameClientInfo gameClientInfo) {
