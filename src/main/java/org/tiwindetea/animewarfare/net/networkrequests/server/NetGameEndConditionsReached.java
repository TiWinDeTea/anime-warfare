 ...
 * @since 0.1.0
 */
public class NetGameEndConditionsReached implements NetReceivable {
    /**
     * Default constructor, required by Kryo.net
     */
    public NetGameEndConditionsReached() {
    }

    public NetGameEndConditionsReached(GameEndConditionsReachedEvent event) {
    }
}
