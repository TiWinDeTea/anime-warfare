 ...
 * @since 0.1.0
 */
public class NetLockFactionRequest implements NetworkedClass {
     ...
     */
    public NetLockFactionRequest() {
        this.faction = null;
        this.gameClientInfo = null;
    }

    public NetLockFactionRequest(FactionType faction, GameClientInfo info) {
