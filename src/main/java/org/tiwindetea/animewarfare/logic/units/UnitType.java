...
public enum UnitType {
	...
	// Cool Guys
	KUBOTA_YOSHINOBU(FactionType.THE_BLACK_KNIGHTS,
			UnitLevel.MASCOT,
			new UnitBasicCharacteristics(UnitBasicCharacteristics.Gender.MALE, false, 0),
			0, 0),
	ACCHAN(FactionType.THE_BLACK_KNIGHTS,
			UnitLevel.LVL0,
			new UnitBasicCharacteristics(UnitBasicCharacteristics.Gender.MALE, false, 0),
			0, 0),
	HAYABUSA_SHOU(FactionType.THE_BLACK_KNIGHTS,
			UnitLevel.LVL1,
			new UnitBasicCharacteristics(UnitBasicCharacteristics.Gender.MALE, false, 0),
			0, 0),
	FUKASE(FactionType.THE_BLACK_KNIGHTS,
			UnitLevel.LVL2,
			new UnitBasicCharacteristics(UnitBasicCharacteristics.Gender.MALE, false, 0),
			0, 0),
	SAKAMOTO(FactionType.THE_BLACK_KNIGHTS,
			UnitLevel.HERO,
			new UnitBasicCharacteristics(UnitBasicCharacteristics.Gender.MALE, false, 0),
			0, 0);
