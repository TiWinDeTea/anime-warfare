...
- **Artiste clown** *(2PP)*
        ...
        Si vous avez des mascottes dans la zone d'affrontements, ils
...
- **Allons dans les buissons...** *(1PP par non-héro, 2PP par héro)*

        Les unités choisies sont invisibles pour les adversaires pour les 3 prochains  tours de phases ou jusq'à ce qu'elle initient une bataille

- **Mes fans... Mes Fans... MES FANS !** *(4PP)*
