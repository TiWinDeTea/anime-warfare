\chapter{Réseau} \label{chapter:reseau}
    ...
    \section{Diagrammes de séquence}
        ...
        \mfigure[t]{width=\linewidth}{seq_moveUnit}{Diagramme de séquence – déplacer une unité}{seq::moveUnit}

        \mfigure[t]{width=\linewidth}{seq_joinGame}{Diagramme de séquence – rejoindre une partie}{seq::joinGame}
