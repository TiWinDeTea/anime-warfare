...
La figure \figref{menu-classes} est le diagramme états-transitions des menus d'accueil.
...
\mfigure[H]{width=0.95\linewidth}{menu_statesmachine.png}{Diagramme états-transitions des menus d'accueil}{menu-statesmachine}
...
\mfigure[H]{width=0.95\linewidth}{menu_classes.png}{Diagramme de classes des menus d'accueil}{menu-classes}
